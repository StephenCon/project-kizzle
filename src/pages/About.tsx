export default function About() {
    return (
        <div className="min-h-screen p-8 flex flex-col items-center text-center animate-fade-in-up">
            <h1 className="text-4xl font-extrabold mb-6">Meet Your Trainer</h1>
            <img
